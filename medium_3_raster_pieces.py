...
groundtruth_balanced_no_road = 'C:/Users/LENOVO/Desktop/thesis/data/2_medium_dataset/groundtruth/no_border/no_road/'
groundtruth_balanced_road = 'C:/Users/LENOVO/Desktop/thesis/data/2_medium_dataset/groundtruth/no_border/road/'
            ...
            for i in range(height_pieces):
                for j in range(width_pieces):
                    ...
                    if os.path.exists(os.path.join(groundtruth_balanced_no_road, piece_name)):
                        output_path = f'C:/Users/LENOVO/Desktop/thesis/data/2_medium_dataset/raster/no_border/no_road/{piece_name}'
                    elif os.path.exists(os.path.join(groundtruth_balanced_road, piece_name)):
                        output_path = f'C:/Users/LENOVO/Desktop/thesis/data/2_medium_dataset/raster/no_border/road/{piece_name}'
                    else:
                        output_path = None
                    if output_path:
