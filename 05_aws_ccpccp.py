...
# CCPCCP - dense - Model
# Added one extra dense layer in the last layer of the moddel + in each layer paired filters for each convolutional layer of the model
model = tf.keras.models.Sequential([
